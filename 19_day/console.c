                ...
                else if (i == 10 + 256)
                {
                    ...
                    else if (strncmp(cmdline, "type ", 5) == 0)
                    {
                        ...
                        if (x < 224 && finfo[x].name[0] != 0x00)
                        {
                            ...
                            file_loadfile(finfo[x].clustno, finfo[x].size, p, fat, (char *)(ADR_DISKING + 0x003e00));
                            cursor_x = 8;
                        ...
                        {
                            putfonts8_asc_sht(sheet, 8, cursor_y, COL8_FFFFFF, COL8_000000, "file not dound.", 15);
                            cursor_y = cons_newline(cursor_y, sheet);
                        }
                        cursor_y = cons_newline(cursor_y, sheet);
                    }
